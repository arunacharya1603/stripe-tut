...
const CartDetails = () => {
    ...
    // payment integration
    // payment integration with improved error handling
    const makePayment = async () => {
        try {
            const stripe = await loadStripe("pk_test_51RERGnQo2eAgjnZcGY9dbeqZo44BoQNsXTlbenbwPozUGT94FFyZXfZqQZ21zZmADJo4azC8xytOdt77Bkb2Hg9n00ZcJr6Q9e");
            ...
            const response = await fetch("https://stripe-tut.vercel.app/api/create-checkout-session", {
                method: "POST",
                headers: headers,
